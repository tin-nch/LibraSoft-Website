...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
            optionsBuilder.UseSqlServer("server=(local);Database=PiranhaCore;Integrated Security=true;");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PiranhaContactForm>(entity =>
        {
            ...
            entity.HasOne(d => d.ReasonReaching)
                ...
                .HasConstraintName("FK__Piranha_C__Reaso__05D8E0BE");
        });
        ...
        modelBuilder.Entity<PiranhaEventParticipant>(entity =>
        {
            ...
            entity.HasOne(d => d.IndustryNavigation)
                .WithMany(p => p.PiranhaEventParticipants)
                .HasForeignKey(d => d.Industry)
                .HasConstraintName("FK_Piranha_EventParticipant_Piranha_CFIndustry");

            entity.HasOne(d => d.ProvinceNavigation)
                .WithMany(p => p.PiranhaEventParticipants)
                .HasForeignKey(d => d.Province)
                .HasConstraintName("FK_Piranha_EventParticipant_Piranha_CFCountry");
        });
        ...
        modelBuilder.Entity<PiranhaPage>(entity =>
        {
            ...
            entity.Property(e => e.MetaPriority).HasDefaultValueSql("((5.000000000000000e-001))");
        });
